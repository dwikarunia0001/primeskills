<template>
  <div class="text-white" style="height:590px">
    <main class="position-absolute top-50 start-50 translate-middle ">
        ...
        <div class="container">
            <div class="bg-warning row justify-content-center p-5 text-white fw-bolder fst-italic border-radius-lg" style="width: 100%;">
            <div>
        ...
        <section class="d-flex justify-content-between px-5 text-white text-center mt-5">
